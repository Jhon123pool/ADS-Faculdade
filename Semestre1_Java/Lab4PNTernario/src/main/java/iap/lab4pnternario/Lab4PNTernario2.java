...
public class Lab4PNTernario2 {
    public static void main(String[] args) {
         ...
         * (se verdadeiro) ou negativo (se falso), também há uma mensagem que avisa se o número digitado
         * é igual a 0 (Zero).
         */
        String resultado = (numero == 0) ? "O número é 0 (Zero)" : (numero > 0) ? "O número " + numero + " é positivo." : "O número " + numero + " é negativo.";
