...
public class Lab8Vetores {
    ...
    int[] B = new int[15];
        ...
        for (int i = 0; i < 15; i++) {
            ...
            /** 
             * Preenche uma posição do vetor 'B' com o atual valor da posição no vetor 'A'
             * multiplicado por ele mesmo (quadrado).
             */
            B[i] = (A[i] * A[i]);
        }
